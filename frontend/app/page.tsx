...
Results for <span className="font-medium text-stone-900 dark:text-stone-100">"{activeQuery}"</span>
</span>
<button
onClick={clearFilters}
...
<>
<span className="text-sm text-stone-600 dark:text-stone-400">
Tag: <span className="font-medium text-stone-900 dark:text-stone-100 capitalize">{selectedTag}</span>
</span>
<button
onClick={clearFilters}
className="flex items-center gap-1 text-xs text-stone-400 hover:text-stone-700 dark:hover:text-stone-200 transition-colors"
...
{displayMode === "list" && (
<p className="tracking-editorial text-stone-400 dark:text-stone-600 text-[11px]">All Artworks</p>
)}
</div>
